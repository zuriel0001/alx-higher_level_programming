...
class TestRectangleMethods(unittest.TestCase):
    ...
    def test_new_rectangle_2(self):
        """Test initialization of a new Rectangle object with all attributes"""
    ...
    def test_valide_attrs(self):
        """Test behavior when passing a string value as an attribute"""
        with self.assertRaises(TypeError):
    ...
    def test_display_2(self):
        """ Test string representation of the rectangle when
        calling display()"""
        r1 = Rectangle(2, 2)
        res = "##\n##\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
    ...
    def test_create(self):
        """Test the create method of the Rectangle class with
        only 'id' parameter
        """
        dictionary = {'id': 89}
    ...
    def test_create_2(self):
        """Test the create method of the Rectangle class with 'id'
    ...
    def test_create_5(self):
        """ Test the create method of the Rectangle class with
        'id', 'width', 'height', 'x' and 'y' parameters
        """
