...
class TestSquareMethods(unittest.TestCase):
    ...
    def test_new_square(self):
        """Test creating a new square with default attributes.

        This test ensures that a new square is created with the provided size
        and default values for other attributes.

        It checks that the size, width, height, x, y, and id attributes are
        set correctly.
    ...
    def test_new_square_2(self):
        """Test creating a new square with all attributes.
         ...
         This test ensures that a new square is created with the provided
         size, width, height, x, y, and id attributes.

         It checks that all the attributes are set correctly.
    ...
    def test_display_3(self):
        """Test the display method for a square """
        s1 = Square(5, 2, 1)
        res = "\n  #####\n  #####\n  #####\n  #####\n  #####\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            s1.display()
